                ...
                <div className={styles.chatContainer}>
                    {!lastQuestionRef.current ? (
                        <div className={styles.chatEmptyState}>
                            <img src={"/logo.png"} />
                            <h1 className={styles.chatEmptyStateTitle}>Enterprise Search</h1>
                            <h2 className={styles.chatEmptyStateSubtitle}>Get Started: Ask Questions and Explore Your Data</h2>
                    ...
                    <div className={styles.chatInput}>
                        <QuestionInput
                            clearOnSend
                            placeholder="Example:What are the e-invoice requirements in Sri Lanka?"
                            disabled={isLoading}
