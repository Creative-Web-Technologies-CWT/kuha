...
class ChatReadRetrieveReadApproach:
    ...
    """
    system_message_chat_conversation = """Assistant helps the PAGERO GROUP stakeholders with their questions on e-invoicing and trade documents in country compliance reports. Be adequate in your answers.
...
{injected_prompt}
"""
    follow_up_questions_prompt_content = """Generate three very brief follow-up questions that the user would likely ask next based on their last question.
Use double angle brackets to reference the questions, e.g. <<Define EN 16931>>.
Try not to repeat questions that have already been asked.
Only generate questions and do not generate any text before or after the questions, such as 'Next Questions'"""

    query_prompt_template = """Below is a history of the conversation so far, and a new question asked by the user that needs to be answered by searching in a knowledge base about various country compliance reports.
...
"""
    ...
    # ]
    query_prompt_few_shots = [
    {'role' : USER, 'content': 'What e-invoicing regulations and standards are enforced by France for compliance in international trade?'},
    {'role' : ASSISTANT, 'content' : 'regulations and standards in France for compliance in international trade' },
    {'role' : USER, 'content': 'explain UN/CEFACT Cross Industry Invoice (CII)'},
    {'role' : ASSISTANT, 'content' : 'UN/CEFACT Cross Industry Invoice (CII) in France' },
    {'role' : USER, 'content': 'What about in Brazil?'},
    {'role' : ASSISTANT, 'content' : 'regulations and standards in Brazil for compliance in international trade and UN/CEFACT Cross Industry Invoice (CII) in Brazil' }
    ]
        ...
        functions = [
            {
                ...
                "parameters": {
                    ...
                    "properties": {
                        "search_query": {
                            "type": "string",
                            "description": "Query string to retrieve documents from azure search eg: 'invoice requirement in Croatia'",
                        }
                    },
