...
class ReadRetrieveReadApproach(AskApproach):
    ...
    template_prefix = (
         "You are a intelligent assistant helps the PAGERO GROUP stakeholders with their questions on e-invoicing and trade documents in country compliance reports. "
...
Thought: {agent_scratchpad}"""
    ...
    CognitiveSearchToolDescription = "useful for searching the PAGERO country compliance information such as e-invoice requirements and regulations, etc."
