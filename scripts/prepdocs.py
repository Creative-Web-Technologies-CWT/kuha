    ...
    for filename in glob.glob(path_pattern):
        ...
        if args.remove:
            ...
            try:
                ...
                destination_directory = os.path.join(os.path.dirname(os.path.dirname(filename)), "processed_data")
                destination_path = os.path.join(destination_directory, os.path.basename(filename))
                shutil.move(filename, destination_path)
                print (f'Succesfully moved file from {filename} to {destination_path}')
...
if __name__ == "__main__":
    ...
    parser.add_argument("--destination", help="To move processed files")
    parser.add_argument(
    ...
    DESTINATION_FOLDER = os.path.join(os.getcwd(), args.destination)
